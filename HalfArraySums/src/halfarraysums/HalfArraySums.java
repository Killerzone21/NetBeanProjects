...
public class HalfArraySums {
    ...
    public static void DetermineEquality(int[] array) {
        int mid;
        boolean found;
        ...
        int FirstHalf = DetermineSum(array, (array.length / 2) - 1, mid);
        int SecondHalf = DetermineSum(array, (array.length - 1), mid);
